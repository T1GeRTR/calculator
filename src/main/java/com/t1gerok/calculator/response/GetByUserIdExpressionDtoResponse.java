...
public class GetByUserIdExpressionDtoResponse {
    private int id;
    private Type type;
    ...
    public GetByUserIdExpressionDtoResponse(int id, Type type, String string, float result, Status status, LocalDateTime datetime, User user) {
        this.id = id;
        this.type = type;
        this.string = string;
        this.result = result;
