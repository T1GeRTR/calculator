...
public class GetByTypeExpressionDtoResponse {
    private int id;
    private Type type;
    ...
    public GetByTypeExpressionDtoResponse(int id, Type type, String string, float result, Status status, LocalDateTime datetime, User user) {
        this.id = id;
        this.type = type;
        this.string = string;
        this.result = result;
